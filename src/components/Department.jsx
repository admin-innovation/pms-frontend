  ...
  return (
    <div className="w-full h-full flex flex-col gap-[8px]">
      ...
      <div className="w-full flex gap-[10px]">
        <div className="w-full flex-[1] bg-[white] rounded-[8px] px-[60px] flex flex-wrap gap-[10px] pt-[100px] ">
          <span className="absolute">Other Staff</span>
          {data.employees?.map((employee, key) => {
            return <EmployeeCard employee={employee} setStaff={setStaffView} />;
          })}
        </div>
        {staffView && (
          <div className="bg-white h-[600px] w-[320px] flex flex-col items-center justify-center rounded-[8px] pb-[10px]  ">
...
const TasksView = ({ employee_id }) => {
  ...
  return (
    <div className="relative w-[90%] h-[50%] rounded-[8px] px-[8px] bg-[#98B4DB]/50 overflow-hidden  ">
      ...
      <div className="relative h-full mb-[30px]  w-full overflow-y-scroll flex flex-col gap-[20px] ">
...
const EmployeeCard = ({ employee, setStaff }) => {
  ...
  return (
    <div
      className="w-[150px] h-[150px] flex flex-col gap-[10px] items-center justify-center
