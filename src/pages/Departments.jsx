...
const Departments = () => {
  ...
  return (
    <div className="w-full">
      <div className="rounded-[8px] font-[700px] bg-[#BACCE7] flex flex-col justify-end">
      ...
      <div className=" h-[50px] rounded-[8px] font-[700px] bg-[#BACCE7] flex flex-col justify-end">
...
const DepartmentTile = ({ title, image, link }) => {
  return (
    <div
      className="bg-cover w-[220px] h-[220px] rounded-[6px] text-white font-[700px] flex flex-col justify-end"
