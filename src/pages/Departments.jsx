...
const Departments = () => {
  ...
  return (
    <>
    <div className=" mt-4 w-[1320px] h-[50px] rounded-[8px] font-[900px] bg-[#BACCE7] text-[#17417E] text-large flex flex-col justify-end">Directorate of Finance & Administration</div>
    <div className=" mt-4 grid grid-cols-5 gap-x-2 gap-y-2">
    ...
    <div className="mt-4 w-[1320px] h-[50px] rounded-[8px] font-[900px] bg-[#BACCE7] text-[#17417E] text-large flex flex-col justify-end align-middle ">Directorate of Technical Services</div>
    <div className="mt-4 grid grid-cols-5 gap-x-2 gap-y-2">
    ...
    <div className="mt-4 w-[1320px] h-[50px] rounded-[8px] font-[900px] bg-[#BACCE7] text-[#17417E] text-large flex flex-col justify-end">Directorate of Marketing & Business Development</div>
    <div className="mt-4 grid grid-cols-5 gap-x-2 gap-y-2">
...
const DepartmentTile =({title, image ,link})=>{
  ...
  return(
    <div className="bg-cover w-[235px] h-[235px] rounded-[6px] text-white font-[700px]  cursor-pointer flex flex-col justify-end"  onClick={()=>{handleDepartment()}} style={{backgroundImage:`url("${image}")`}}>
        {title}
    </div>
  )
}
