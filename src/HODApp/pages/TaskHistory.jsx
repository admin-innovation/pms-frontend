...
import { TaskHistorys } from "../../data/temp";
    ...
    <>
      <div>
        <div className="flex items-center w-full p-1 bg-white text-[#838486] rounded-t-[8px]  ">
          <div className="w-[35%] text-center">Task Title</div>
          <div className="w-[18%] text-center ">Rating</div>
          <div className="w-[17%] text-center ">Date completed</div>
          <div className="w-[14%] text-center">Members</div>
        </div>
        <div className=" w-full  bg-white rounded-b-[8px]  min-h-[73vh] mt-[-3px]">
          <div className="">
            {TaskHistorys.map((item, key) => {
              return (
                <TaskRow
                  title={item.title}
                  status={item.status}
...
const TaskRow = ({ title, status, date, people, rating }) => {
  ...
  return (
    <>
      <div className="relative w-full flex flex-row items-center px-[10px]  bg-white pt-[10px] border-b-[1px] border-b-[#656667]/10 text-pretty">
        <div className="w-[40%] flex items-center gap-2.5 pb-[15px]">
          ...
          <div className="note text-pretty">
            <p>{title}</p>
          </div>
        </div>
        ...
        <div className="text-sm w-[24%]  h-full text-center">{date}</div>
