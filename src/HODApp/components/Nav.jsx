...
const Nav = () => {
  ...
  const navItems = [
    ...
    { title: "Task", link: "tasks", icon: FaTasks },
    { title: "Review", link: "reviews", icon: MdReviews },
    { title: "Staff", link: "staff", icon: FaPeopleGroup },
    { title: "Analytics", link: "analytics", icon: MdChecklist },
  ];
